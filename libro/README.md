...
> **Escala vigente.** Manual de **~170 páginas y 14 capítulos**. El plan del libro 1 es
...
> Los esqueletos de versiones anteriores están fuera, en `anexos/` — el largo es el mapa del
> **libro 2**. El historial de decisiones está en `HISTORIAL.md`. Ninguno entra en el PDF.
